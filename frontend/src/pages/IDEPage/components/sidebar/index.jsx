...
<Explorer selectedTab={selectedTab} projectStructure={projectStructure}  selectedProject={selectedProject} handleInfoButtonClick={handleInfoButtonClick} createId={createId}/>
</>
)
}
