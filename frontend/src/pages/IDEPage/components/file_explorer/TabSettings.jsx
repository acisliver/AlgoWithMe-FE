export default function TabSettings({handleInfoButtonClick,createId}) {
  ...
  return (
    <div style={{width : '440px', border: '0.5px solid black'}} className='bg-[#0E1525]  text-white flex '>
      ...
      Settings
        <button className="flex text-sm leading-3 pl-2 pt-2 items-center " onClick={()=>handleInfoButtonClick(createId)}> 
