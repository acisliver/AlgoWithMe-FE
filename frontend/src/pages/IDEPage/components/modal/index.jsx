                                ...
                                <Box sx={style}>
                                    <Typography id="modal-modal-title" variant="h6" component="div" className='flex' style={{height:'500px'}} >
                                        <div className=' bg-white text-black rounded-2xl p-4 flex flex-col' style={{width : '230px', height:'475px'}}>
                                            <button  disabled={isEditing} className={`flex p-1 hover:bg-slate-200`}  
                                            onClick={() => handleTemplateClick('Java')}>Java</button>
                                            <button  disabled={isEditing} className={`flex p-1 hover:bg-slate-200`}   
                                            onClick={() => handleTemplateClick('JavaScript')}>JavaScript</button>
                                            <button  disabled={isEditing} className={`flex p-1 hover:bg-slate-200`}   
                                            onClick={() => handleTemplateClick('Py')}>Python</button>
                                        </div>
